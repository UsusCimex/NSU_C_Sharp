...
namespace DreamTeamConsole.Tests
{
    ...
    {
        [Fact]
        public void GenerateTeams_NumberOfTeamsMatches()
        {
        ...
        [Fact]
        public void GenerateTeams_WithPredefinedPreferences_ReturnsExpectedDistribution()
        {
            var hrManager = new HrManager();
            var teamLeads = new List<Employee>
            {
        ...
        [Fact]
        public void GenerateTeams_StrategyCalledOnce()
        {
            var hrManager = new HrManager();
            var teamLeads = new List<Employee>();
            var juniors = new List<Employee>();
