...
namespace DreamTeam.Strategy 
{
    public class MegaTeamBuildingStrategy : ITeamBuildingStrategy
    {
        public IEnumerable<Team> BuildTeams(
            ...
            var teamLeadWishlists = teamLeadsWishlists.ToDictionary(w => w.EmployeeId, w => w.DesiredEmployeeIds);
            var juniorWishlists = juniorsWishlists.ToDictionary(w => w.EmployeeId, w => w.DesiredEmployeeIds);
